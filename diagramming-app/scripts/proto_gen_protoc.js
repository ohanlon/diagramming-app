...
function main() {
  ...
  const hasProtoc = checkTool('protoc');
  if (!hasProtoc) {
    ...
    console.error('On Windows: download protoc from https://github.com/protocolbuffers/protobuf/releases');
  ...
  // Generate JS runtime stubs (use commonjs style for compatibility)
